...
CREATE TABLE test.`user` (
  ...
  `first_name` VARCHAR(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'utf8mb4',
  ...
  `creation_user` VARCHAR(64) DEFAULT NULL COMMENT '创建的用户',
  `modify_date` DATETIME DEFAULT now() COMMENT 'UTC记录最后一次修改 0000-00-00 00:00:00',
  `modify_user` VARCHAR(64) DEFAULT NULL COMMENT '记录最后一次修改',
  PRIMARY KEY (`user_id`),
